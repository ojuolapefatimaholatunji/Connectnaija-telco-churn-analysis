...
6. Do value-added services (Tech Support, Online Security) 
   reduce churn?
7. Are senior citizens more likely to churn than non-seniors?
8. What does the complete profile of a churning customer 
   look like?
...
5. Created Date Table and marked as date table
6. Unpivoted add-on service columns for clustered 
...
- Avg Tenure (Churned)
- Dynamic insight text for all charts
